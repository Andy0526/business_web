...
from helper import textprocessing as tp
...
posdict = tp.get_txt_data(r"./data/sentiment_dictionary/posdict.txt","lines")
negdict = tp.get_txt_data("./data/sentiment_dictionary/negdict.txt","lines")

# Load adverbs of degree dictionary
mostdict = tp.get_txt_data('./data/sentiment_dictionary/most.txt', 'lines')
verydict = tp.get_txt_data('./data/sentiment_dictionary/very.txt', 'lines')
moredict = tp.get_txt_data('./data/sentiment_dictionary/more.txt', 'lines')
ishdict = tp.get_txt_data('./data/sentiment_dictionary/ish.txt', 'lines')
insufficientdict = tp.get_txt_data('./data/sentiment_dictionary/insufficiently.txt', 'lines')
inversedict = tp.get_txt_data('./data/sentiment_dictionary/inverse.txt', 'lines')
